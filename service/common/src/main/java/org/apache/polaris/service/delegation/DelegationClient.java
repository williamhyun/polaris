...
public interface DelegationClient {
   ...
   * <p>This method:
   * <ol>
   *   <li>Checks if delegation is enabled and appropriate</li>
   *   <li>If delegation is enabled, makes a BLOCKING HTTP call to delegate ONLY the data file cleanup</li>
   *   <li>WAITS for the delegation service to complete the data file deletion</li>
   *   <li>Returns true ONLY after delegation service confirms completion</li>
   *   <li>If delegation is disabled, returns false to indicate local execution should be used</li>
   *   <li>If delegation fails, returns false (no fallback - operation should fail)</li>
   * </ol>
   * 
   * <p><strong>CRITICAL TIMING:</strong> This method blocks the calling thread until the delegation 
   * service completes the data file cleanup operation. Do NOT proceed with metadata removal 
